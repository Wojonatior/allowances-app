    ...
    return (React.createElement(react_native_1.View, { style: styles.root },
        ...
        React.createElement(react_native_1.View, { style: styles.buttons },
            React.createElement(react_native_1.View, { style: styles.button },
                React.createElement(react_native_1.Button, { title: "-", onPress: onDecrement || (() => { }), accessibilityLabel: "decrement", color: 'red' })),
            React.createElement(react_native_1.View, { style: styles.button },
                React.createElement(react_native_1.Button, { title: "+", onPress: onIncrement || (() => { }), accessibilityLabel: "increment", color: 'blue' })))));
}
